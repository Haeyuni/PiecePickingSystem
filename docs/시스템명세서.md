...
| `planner/` | Python 3.12 (**COLCON_IGNORE**, 순수 Python) | FastAPI(`app.py`), LLM SDK(`llm_client.py`), VLM 호출(`vlm_client.py`), DB 클라이언트(`db.py`) | GPU 불필요. ROS2와 무관 — web을 거쳐서만 control에 도달 |
